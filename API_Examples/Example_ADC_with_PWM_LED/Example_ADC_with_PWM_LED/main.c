/* DESCRIPTION
 * Sample code structure with ADC input and then running a PWM setup to control connected to a LED on P1.6
 * This example: Turns the LED on at two different brightness level depending on ADC value
*/
...
void main (void)
{
     ...
     GPIO_setAsPeripheralModuleFunctionInputPin(GPIO_PORT_ADC8, GPIO_PIN_ADC8, GPIO_FUNCTION_ADC8); // ADC analog input pin used
